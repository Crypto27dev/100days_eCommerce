...
const stripeKey = "pk_test_51JCiUfSDU2GWp7bi0VACBFYVB9vcGSEhdg4RQrosWyqZyIvETK6kud3YTIXQ8kjqHEbTRUEvmu3AdWdQ9NSeUtyV00JQVSrn6E";
...
const routes = [
    ...
    {
        path: 'payment',
        element: <Elements stripe={stripePromise} > <ProtectedRoute> <Payment /> </ProtectedRoute> </Elements>
    },
